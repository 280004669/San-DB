package top.sanc.mydb.backend.parser;

import java.util.ArrayList;
import java.util.List;

import top.sanc.mydb.backend.parser.statement.Abort;
import top.sanc.mydb.backend.parser.statement.Begin;
import top.sanc.mydb.backend.parser.statement.Commit;
import top.sanc.mydb.backend.parser.statement.Create;
import top.sanc.mydb.backend.parser.statement.Delete;
import top.sanc.mydb.backend.parser.statement.Drop;
import top.sanc.mydb.backend.parser.statement.Insert;
import top.sanc.mydb.backend.parser.statement.Select;
import top.sanc.mydb.backend.parser.statement.Show;
import top.sanc.mydb.backend.parser.statement.SingleExpression;
import top.sanc.mydb.backend.parser.statement.Update;
import top.sanc.mydb.backend.parser.statement.Where;
import top.sanc.mydb.common.Error;
